                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p class="summary-text">duration / other detail</p>
                                    <p>Price: ฿150.00 ฿180.00</p>
                                    <div class="action-row">
                                        <button class="btn primary-action-btn">
                                            <i class="bi bi-calendar-check"></i> Search Session http://localhost:8104/en-th/@eikin-japanese-school/service-booking/BA31737B2/BA31C5698/schedules
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="action-row">
                                        <button class="btn primary-action-btn">
                                            <i class="bi bi-calendar-check"></i> Search Session
                                        </button>
                                    </div>
                                </div>
                            </div>
