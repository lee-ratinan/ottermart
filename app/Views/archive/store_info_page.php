...
<!--                <h2 class="mt-3">--><?php //= $business['business_name'] ?><!--</h2>-->
<!--                <div class="my-3">-->
<!--                    --><?php //if (is_array($business['social_media'])) : ?>
<!--                        --><?php //foreach ($business['social_media'] as $social_key => $social_link) : ?>
<!--                            --><?php //if (!empty($social_link)) : ?>
<!--                                <a class="btn btn-outline-dark mx-2" href="--><?php //= $social_link ?><!--" target="_blank"><i class="fa-brands fa---><?php //= $social_key ?><!--"></i></a>-->
<!--                            --><?php //endif; ?>
<!--                        --><?php //endforeach; ?>
<!--                    --><?php //endif; ?>
<!--                </div>-->
